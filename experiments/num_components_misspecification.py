...
fig, ax = plt.subplots()
ax.set_xlabel('Generative number of components', fontsize=12)
ax.set_xticks(np.arange(len(NUM_COMPONENTS)+1))
ax.set_xticklabels(NUM_COMPONENTS, fontsize=12)
ax.set_ylabel('Fitted number of components', fontsize=12)
ax.set_yticks(np.arange(len(NUM_COMPONENTS)+1))
ax.set_yticklabels(NUM_COMPONENTS, fontsize=12)
